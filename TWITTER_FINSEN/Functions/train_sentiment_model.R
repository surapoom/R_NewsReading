...
train_sentiment_model <- function(joined_dataset, path_model){
  ...
  write_rds(dat21, "C:/LazyTrading/GitHub/R_NewsReading/TWITTER_FINSEN/Model/truth_res.rds")
  
  # write predicted results 
  write_rds(result, "C:/LazyTrading/GitHub/R_NewsReading/TWITTER_FINSEN/Model/predicted_res.rds")
